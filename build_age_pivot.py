...
INPUT_TSV = "visits_with_dob.tsv"   # RESORT, ARRIVAL_DATE, NAME_ID, RESV_NAME_ID, DOB
CSV_OUT   = "pivot_by_age_group.csv"
XLSX_OUT  = "pivot_by_age_group.xlsx"  # по избор; може да се махне
YEAR_FROM = 2017
YEAR_TO   = 2025
...
print("Building pivot 2017..2025...")
