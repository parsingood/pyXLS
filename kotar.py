...
SELECT 
 ...
 AND UPPER(SO.COMPANY) LIKE 'SUD%'
 AND R.TRUNC_BEGIN_DATE between TO_DATE('30072025','DDMMYYYY') and TO_DATE('16092025','DDMMYYYY')
 AND R.RESORT IN ('LAB','LAM','ORL','DOR')
'''
...
msg = EmailMessage()
msg['Subject'] = 'KOTAR Reservations'
msg['From'] = sender_email
msg['To'] =  receiver_email[0]
msg.set_content('KOTAR Reservations')
