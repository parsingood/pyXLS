...
to_email ="maya.lazarova@albena.bg"

receiver_email = ["mtodorova@albena.bg","maya.lazarova@albena.bg","velina.gyumova@albena.bg","ivanm@albena.bg","reservations@whitelagoon.bg","primorsko@albena.bg"]


#mailserver = "mail.albena.bg"
directory = "C:/test/"

#to_email ="reservations@whitelagoon.bg"

#receiver_email = ["reservations@whitelagoon.bgg","ivanm@albena.bg","primorsko@albena.bg"]
...
workbook = xlsxwriter.Workbook('C:/test/OccupTrend-'+dt_string+'.xlsx')
