...
body = "Заетост за 160 дни напред по хотели и тур-агенти в нощувки и стаи, според постъпилите резервации към момента, без незаетите блокирани по гаранции и out-of-order стаи"


to_email ="marinela.tsaneva@albena.bg"
receiver_email = ["marinela.tsaneva@albena.bg","ivanm@albena.bg"] # ,"mtodorova@albena.bg","maya.lazarova@albena.bg"
