        ...
        (
	     ...
	     , MAX(EN.RATE_CODE) RATE_CODE
          ...
          WHERE T.ROOM_CLASS <> 'P'
            ...
            AND E.RESERVATION_DATE BETWEEN TO_DATE('01012024' ,'DDMMYYYY')  AND TO_DATE('30112025' ,'DDMMYYYY')  
            AND RS.STATE in (
			'ALB','WLA','PRI'
		)            
 ...
 INSERT
    INTO TRAIN.ALB_TRENDS
     ...
     SELECT current_date, SOURCE_ID, J.RESORT,RESERVATION_DATE,
      ...
      AND j.reservation_date > TO_DATE('01.04.2024','DD.MM.YYYY')
      AND R.STATE='ALB'
      group by 
        SOURCE_ID,
        J.RESORT,
